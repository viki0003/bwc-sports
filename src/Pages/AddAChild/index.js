            ...
            <div className="add-child-container">
                ...
                <div className="add-child-image-container">
                    ...
                    <div className="adding-image-container">
                        <span className="adding-icon"><AddIcon/></span>
                        <p className="child-overlay-text adding-child-text">Add Another Child</p>
                    </div>
                </div>
                <div className="add-child-submit-button">
                <button type="submit" className="p-submit-button add-child-btn">Proceed</button>
                </div>
